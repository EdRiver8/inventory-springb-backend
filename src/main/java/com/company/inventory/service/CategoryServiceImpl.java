...
import com.company.inventory.util.Constants;
...
public class CategoryServiceImpl implements ICategoryService {
    ...
    @Override
    // this method will not modify the DB. It's a hint for persistence provider can
    ...
    public ResponseEntity<CategoryResponseRest> search() {
        ...
        response.setCategoryResponseList(categoryResponseList); // Set the initialized CategoryResponseList to the
                                                                // response
        try {
            List<Category> categories = categoryDao.findAll();
            if (!categories.isEmpty()) { // Check if categories is not null
                response.getCategoryResponseList().setCategories(categories);
                response.setMetadata(Constants.SUCCESS, Constants.SUCCESS_CODE, Constants.SEARCH_CATEGORIES_OK);
            } else {
                response.setMetadata(Constants.ERROR, Constants.ERROR_CODE, Constants.SEARCH_CATEGORIES_ERROR);
